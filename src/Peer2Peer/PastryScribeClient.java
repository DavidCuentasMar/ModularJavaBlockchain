...
public class PastryScribeClient implements ScribeClient, Application {
    ...
    public void sendMulticast(String msg) {
        if (myScribe.containsTopic(myTopic)) {
            ...
            PastryScribeContent myMessage = new PastryScribeContent(endpoint.getLocalNodeHandle(), msg, PastryScribeContent.contentType.CHAIN);
    ...
    public boolean isChainRequest(PastryScribeContent msg) {
        return msg.content.equals("CHAIN_REQUEST")
                && (msg.type == PastryScribeContent.contentType.TEXT);
    }
    ...
    public boolean isChainDelivery(PastryScribeContent msg) {
        return (this.REQUEST_CHAIN == true
                && (msg.type == PastryScribeContent.contentType.CHAIN));
    }
    ...
    public void sendTransaction(String trans) {
        if (myScribe.containsTopic(myTopic)) {
            ...
            PastryScribeContent myMessage = new PastryScribeContent(endpoint.getLocalNodeHandle(), trans, PastryScribeContent.contentType.TRANSACTION);
            myScribe.publish(myTopic, myMessage);
        } else {
            System.out.println("Ups. Parece que aún no te has suscrito.");
        }
    ...
    public void sendBlock(String block) {
        if (myScribe.containsTopic(myTopic)) {
            ...
            PastryScribeContent myMessage = new PastryScribeContent(endpoint.getLocalNodeHandle(), block, PastryScribeContent.contentType.BLOCK);
            myScribe.publish(myTopic, myMessage);
        } else {
            System.out.println("Ups. Parece que aún no te has suscrito.");
        }
